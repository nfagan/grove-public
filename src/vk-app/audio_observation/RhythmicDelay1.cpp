...
AudioParameterMonitor::MonitorableNode RhythmicDelay1::make_node(ValueCB&& signal_rep_cb) {
  auto signal_cb_method = AudioParameterMonitor::CallbackMethod::OnUpdate;
